...
export const projects: Project[] = [
  {
    ...
    description: 'A modern e-commerce platform built with Vue 3 and Node.js, featuring real-time inventory management, payment integration, and advanced analytics.',
  ...
  },
  {
    ...
    description: 'Collaborative task management application with real-time updates, team workspaces, and intelligent task prioritization.',
  ...
  },
  {
    id: 3,
    title: 'Portfolio CMS',
    description: 'Content management system designed specifically for creative portfolios, with drag-and-drop interface and custom theming.',
