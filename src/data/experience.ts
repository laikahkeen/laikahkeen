...
export const experiences: Experience[] = [
  {
    ...
    location: 'Remote',
    description:
      'Building a multi-tenant SaaS product — and the internal AI tooling the engineering team uses to build it. Part-time and contract here from Apr 2024 to Aug 2025 before going full-time.',
    responsibilities: [
      'Wrote an internal MCP server in Go, now hosted and adopted across the engineering team to connect AI coding agents to the company task tracker',
