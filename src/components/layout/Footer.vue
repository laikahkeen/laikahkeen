    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
      <div class="flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div class="text-center md:text-left">
          <p class="font-mono font-semibold text-lg">Lai Kah Keen</p>
        ...
        <div class="text-center md:text-right">
          <p class="text-gray-400 text-sm">
            &copy; {{ new Date().getFullYear() }} Lai Kah Keen. All rights reserved.
          </p>
        </div>
      </div>
    </div>
...
const socials: Social[] = [
  {
    name: 'GitHub',
    url: 'https://github.com/laikahkeen',
  ...
  {
    name: 'LinkedIn',
    url: 'https://linkedin.com/in/laikahkeen',
    icon: () => h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
  ...
  {
    name: 'Email',
    url: 'mailto:hello@laikahkeen.com',
    icon: () => h('svg', { fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24', strokeWidth: 2 }, [
